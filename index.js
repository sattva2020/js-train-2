...
function calculateExpression(expression) {
  if (typeof expression === "string") {
    // Виконуємо код, якщо аргумент є рядком
    return eval(expression);  //Преревіряємо чи аргумент є рядком //Якщо так повертаємо виконананий код
  } else {
...
function isNumberFinite(num) {
  // Використовуємо вбудовану функцію isFinite, щоб перевірити, чи є введене число скінченним. // Ця функція повертає true, якщо число є скінченним, і false, якщо число є нескінченним або не є числом.
...
function createURLObject(urlStr) {
  encodeURL(urlStr); // Використовуємо вбудований конструктор URL, щоб створити новий об'єкт URL з введеного рядка.
  return urlStr; // Повертаємо створений об'єкт URL.
}
...
function encodeURLComponent(urlComponent) {
  const encodedComponent = encodeURIComponent(urlComponent);    // Використовуємо вбудовану функцію encodeURIComponent, щоб закодувати введений компонент URL.
